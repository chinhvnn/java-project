          ...
          <div class="top-left pull-left">
            <div class="language">
              <form action="#" method="post" enctype="multipart/form-data" id="language">
                <div class="btn-group">
                  ...
                  <img src="resources/image/flags/vn.png" alt="Vietnamese" title="Vietnamese">Vietnamese <i class="fa fa-caret-down"></i></button>
                  <ul class="dropdown-menu">
                    <li><a href="#"><img src="resources/image/flags/vn.png" alt="Vietnamese" title="Vietnamese"> Vietnamese</a></li>
            ...
            <div class="currency">
              <form action="#" method="post" enctype="multipart/form-data" id="currency">
                <div class="btn-group">
                  <button class="btn btn-link dropdown-toggle" data-toggle="dropdown"> <strong>VND</strong> <i class="fa fa-caret-down"></i> </button>
                  <ul class="dropdown-menu">
                    <li>
                      <button class="currency-select btn btn-link btn-block" type="button" name="VND">VND</button>
                    </li>
                    <li>
          ...
          <div class="top-right pull-right">
            <div id="top-links" class="nav pull-right">
              <ul class="list-inline">
                ...
                <li class="dropdown account"><a href="#" title="My Account" class="  dropdown-toggle" data-toggle="dropdown"> <i class="fa fa-user"></i>
                ...
                <li class="dropdown account"><a href="#" title="My Account" class="  dropdown-toggle" data-toggle="dropdown"> <i class="fa fa-user"></i>
                <span>${LoginSuccess.email }</span> <span class="caret"></span></a>
                  <ul class="dropdown-menu dropdown-menu-right">
              ...
              <form action = "search-page1&show8&sort1">
                <input class="input-text" placeholder="Search By Products.." type="text" name="keyword">
    ...
    <div class="header-inner">
      <div class="col-sm-4 col-xs-6 header-left">
        <div class="shipping">
          ...
          <div class="shipping-text">(+84) 0905.666.391<br>
            <span class="shipping-detail">24/7 HỖ TRỢ TRỰC TUYẾN</span></div>
        </div>
      </div>
      <div class="col-sm-4 col-xs-12 header-middle">
        <div class="header-middle-top">
          <div id="logo"> <a href="/home"><img src="resources/image/logo.png" title="E-Commerce" alt="E-Commerce" class="img-responsive" /></a> </div>
        </div>
      </div>
      <div class="col-sm-4 col-xs-12 header-right">
        <div id="cart" class="btn-group btn-block">
          ...
          ${totalQuatityBill} item(s) - <fmt:formatNumber type="number" groupingUsed="true" value="${totalPriceBill}"/> đ</span> </button>
          <ul class="dropdown-menu pull-right cart-dropdown-menu">
            ...
            <li>
              <div>
                ...
                <p class="text-right"> <span class="btn-viewcart"><a href="cart"><strong><i class="fa fa-shopping-cart"></i> View Cart</strong></a></span> <span class="btn-checkout"><a href="checkout"><strong><i class="fa fa-share"></i> Checkout</strong></a></span> </p>
              </div>
            </li>
          </ul>
        </div>
    ...
    <nav id="menu" class="navbar">
      <div class="nav-inner">
        ...
        <div class="navbar-collapse">
          ...
          <c:forEach var="item1" items="${ menus }">
          		<c:if test="${ not item1.isSubmenu }">
          		<li><a href="${ item1.link }" class="parent">${ item1.name }</a> </li>
          		</c:if>	
          		<c:if test="${ item1.isSubmenu }">
          		<li><a href="#" class="active parent">${ item1.name }</a> 
          			<ul>
          			<c:if test="${ item1.name== 'THƯƠNG HIỆU' }">
          				<c:forEach var="item" items="${ brands }">
	            		<li><a href="filter-page1&show8&sort1?brand=${ item.id }"> ${ item.brand_name } </a></li>
	            		</c:forEach>
          			</c:if>
            		</ul>
          		</li>
      ...
      <div class="col-sm-3 footer-block">
        <div class="content_footercms_right">
          <div class="footer-contact">
            ...
            <ul class="ul-wrapper">
              <li><i class="fa fa-map-marker"></i><span class="location2"> Tòa nhà làm việc,<br>
                12345 Street name, Đà Nẵng<br>
                Việt Nam</span></li>
              <li><i class="fa fa-envelope"></i><span class="mail2"><a href="#">info@localhost.com</a></span></li>
              <li><i class="fa fa-mobile"></i><span class="phone2">+84 0000-000-000<br>+84 0000-000-000</span></li>
            </ul>
          </div>
        </div>
      </div>
...
<div class="footer-bottom">
  <div class="container">
    <div class="copyright">Powered By &nbsp;<a class="yourstore" href="#">ChinhLv &copy; 2021 </a> </div>
