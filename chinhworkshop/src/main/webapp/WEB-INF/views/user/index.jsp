...
<div class="container">
  ...
  <div class="row">
    <div id="content" class="col-sm-12">
      <div class="customtab">
        <div id="tabs" class="customtab-wrapper">
          <ul class='customtab-inner'>
            <li class='tab'><a href="#tab-latest">SẢN PHẨM MỚI</a></li>
            <!-- <li class='tab'><a href="#tab-special">PHIÊN BẢN ĐẶC BIỆT GIỚI HẠN</a></li> -->
                ...
                <div class="product-thumb transition">
                  ...
                  <img src="resources/image/product/${item.img}" alt="lorem ippsum dolor dummy" title="lorem ippsum dolor dummy" class="img-responsive" /> </a>
                    <div class="button-group">
                      <button type="button" class="wishlist" data-toggle="tooltip" title="Thêm vào mục yêu thích" ><i class="fa fa-heart-o"></i></button>
                      <button type="button" class="addtocart-btn" >MUA NGAY</button>
                      <button type="button" class="compare" data-toggle="tooltip" title="So sánh sản phẩm này" ><i class="fa fa-exchange"></i></button>
                    </div>
                  </div>
      ...
      <h3 class="productblock-title">SẢN PHẨM BÁN CHẠY</h3>
      <div class="box">
     ...
     <h3 class="productblock-title">ĐÁNH GIÁ KHÁCH HÀNG</h3>
      <div class="parallax">
