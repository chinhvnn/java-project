...
<div class="container">
  <ul class="breadcrumb">
    ...
    <li><a href="./collection">TÌM KIẾM</a></li>
  </ul>
  <div class="row">
    ...
    <div id="content" class="col-sm-9">
      ...
      <div class="row category-banner">
        ...
        <div class="col-sm-12 category-desc">Lorem ipsum dolomagna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate.</div>
               ...
               <!-- Thanh sap xep -->
     <%@ include file = "/WEB-INF/views/layouts/sort-panel_search.jsp" %>
      <br />
      <div class="grid-list-wrapper">
      <c:if test="${!empty search_products}">
      <c:forEach items="${ search_products }" var="item"> 
      ...
      <c:if test="${empty search_products}"> <p> Không tìm thấy kết quả nào</p></c:if>
            
      </div>
      <%@ include file = "/WEB-INF/views/layouts/pagination_search.jsp" %>
    </div>
  </div>
</div>
</body>