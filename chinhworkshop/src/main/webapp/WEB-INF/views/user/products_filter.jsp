...
<div class="container">
  <ul class="breadcrumb">
    ...
    <li><a href="./collection">LỌC SẢN PHẨM</a></li>
  </ul>
  <div class="row">
    ...
    <div id="content" class="col-sm-9">
      ...
      <div class="row category-banner">
        ...
        <div class="col-sm-12 category-desc">Lorem ipsum dolomagna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate.</div>
         ...
         <!-- Thanh sap xep -->
     <%@ include file = "/WEB-INF/views/layouts/sort-panel_filter.jsp" %>
      <br />
      <div class="grid-list-wrapper">
      <c:if test="${!empty filter_products}">
      <c:forEach items="${ filter_products }" var="item"> 
      ...
      <c:if test="${empty filter_products}"> <p> Không tìm thấy kết quả nào</p></c:if>
      </div>
      <%@ include file = "/WEB-INF/views/layouts/pagination_filter.jsp" %>
    </div>
  </div>
</div>
</body>