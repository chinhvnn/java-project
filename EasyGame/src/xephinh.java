...
public class xephinh extends JFrame implements ActionListener {
	JButton b1, b2, b3, b4, b5, b6, b7, b8, b9, next;

	xephinh() {
		super("Puzzle Game - HocLapTrinh");
		b1 = new JButton("1");
		b2 = new JButton(" ");
		b3 = new JButton("3");
		b4 = new JButton("4");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == b9) {
			...
			if (b1.getLabel().equals("1") && b2.getLabel().equals("2") && b3.getLabel().equals("3")
				...
				JOptionPane.showMessageDialog(xephinh.this, "!!!you won!!!");
			}
		} // ket thuc if
